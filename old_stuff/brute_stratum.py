...
def get_stratums_sample(num_squares, model='rand', genus=False, num_samples=1000):
    '''
...
def compare_fixed_unfixed(num_squares, genus=False, num_samples=1000):
    ...
    stratums_fixed = get_stratums_sample(num_squares, model='fixed_conj', genus=genus, num_samples=num_samples) 
